...
Needed files:
- v3_generated_sentences_adj.txt: The flattened English corpus generated by the sentence generator.
- synset_pos_artificial_{lang}_edges_adj_augmented.json: The dictionary files for each target language.
- corpus_{lang}_synset.txt: The generated corpora for each target language.

Usage:
    python create_overlapped_corpora.py \
        --eng_corpus_path v3_generated_sentences_adj.txt \
...
def overwrite(corpus_path, replacement_mapping, lang, target_percentage, strategy):
    ...
    output_corpus_path = f"overlapped_corpora/corpus_{lang}_P{int(target_percentage)}_{strategy}.txt"
    ...
    for target_percentage in percentage_values:
        for strategy in strategies:
            ...
            for lang in languages:
                ...
                dictionary_path = f"synset_pos_artificial_{lang}_edges_adj_augmented.json"
...
def main():
    ...
    p.add_argument("--eng_corpus_path", type=str, required=True, help="Path to the flattened English corpus.")
    p.add_argument("--languages", type=str, nargs='+', required=True, help="List of target languages.")
    args = p.parse_args()

    create_corpora(args.eng_corpus_path, args.languages)
