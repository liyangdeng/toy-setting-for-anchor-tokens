...
This is an assembled ("集合") version of two existing repo tools:
  - anchor_necessity/generate_sentences_no_anchors.py  (punctuation-free PCFG generator)
...
gen = _load_module(REPO / 'Experiment/experiments/anchor_necessity/generate_sentences_no_anchors.py',
                   'gen_no_anchors')
